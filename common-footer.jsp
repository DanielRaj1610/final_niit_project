          ...
          <div class="pull-right">
                ...
                <nav class="navbar" style="background:transparent; color: black;">
                 ...
                 <nav class="nav navbar-nav pull-xs-left">
                        ...
                        <a class="nav-item nav-link" href="#">&copy Copyrights</a>

         

               <a class="nav-item nav-link" href="#">Tronicsville</a>

                        <a class="nav-item nav-link" href="#">2016</a>

      

                  <a class="nav-item nav-link" href="#">All Rights Reserved</a>
